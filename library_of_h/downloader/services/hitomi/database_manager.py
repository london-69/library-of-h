...
class HitomiDatabaseManager(DatabaseManagerBase):
    ...
    def insert_into_table(self, gallery_metadata: HitomiGalleryMetadata) -> None:
        ...
        self._insert_into_sources(gallery_metadata.gallery_id, "hitomi")
        ...
        for tag_name in gallery_metadata.tags:
            ...
            self._insert_into_tags(gallery_metadata.gallery_id, tag_name, tag_sex)
